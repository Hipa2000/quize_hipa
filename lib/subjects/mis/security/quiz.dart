    ...
    return Column(
      ...
      children: [
          ...
          style: const TextStyle(
              ...
              color: Color.fromARGB(255, 14, 156, 175),
              fontSize: 50),
        ),
        Question(widget.s1[widget.questionIndex]['questionText'].toString()),
        ...(widget.s1[widget.questionIndex]['answers'] as List<Map<String, Object>>)
            .map((answer) {
          return Answer(
