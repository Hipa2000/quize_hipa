    ...
    return Column(
      ...
      children: [
          ...
          style: const TextStyle(
              ...
              color: Color.fromARGB(255, 21, 219, 64),
              fontSize: 50),
        ),
        Question(widget.A8[widget.questionIndex]['questionText'].toString()),
        ...(widget.A8[widget.questionIndex]['answers'] as List<Map<String, Object>>)
            .map((answer) {
          return Answer(
